...
<head>
    ...
    <script type="text/javascript">
        function addCart() {
            ...
            location.href="http://localhost:8085/cart/addCart?gid="+goodsId+"&num="+goodsNum;
        }
    ...
    height: 360px"/></a></li>
            ...
            <div class="dt-if1-qietu">
                ...
                <div class="dt-qie-con f-l">
                    <ul qie-xiao="" >
                        <#list picList as pic>
                        <li class="current" ><a href="#"><img style="
    height: 60px" src="${pic}"/></a></li>
                        </#list>
                        <div style="clear:both;"></div>
                    </ul>
        ...
        <div class="dt-if1-m f-l">
            ...
            <div class="dt-ifm-gojia">
                <dl>
                    ...
                    <dd>
                        <p class="p1">
                            <span class="sp1" >¥${goods.gprice}</span><span class="sp2">29.50</span>
                        </p>
                        <p class="p2">
            ...
            <dl class="dt-ifm-box3">
                ...
                <dd>
                    ...
                    <input type="text" id="goodsNum"  value="1">
            ...
            <div class="dt-ifm-box4">
                ...
                <button class="btn2" onclick="addCart()">加入购物车</button>
